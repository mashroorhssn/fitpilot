...
export const ENV = {
  ...
  // Gemini 3 series. gemini-3.5-flash and gemini-3.1-flash-lite are the current
  // free-tier-eligible models (Gemini 3.1 Pro is paid-tier only as of Apr 2026).
  MODEL_SMART: process.env.GEMINI_MODEL_SMART || "gemini-3.5-flash",
