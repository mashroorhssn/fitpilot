...
When delegating, write a SELF-CONTAINED request: include the concrete date (e.g. "${todayISO()}"), the relevant plan details you already know (day name, slot), and the user's exact ask. Specialists have tools for schedule/plan/targets — never tell them to ask the user for session length or workload score.
